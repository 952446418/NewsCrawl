...
class jinritoutiao():
    ...
    def fun_url(self, web, keys):
        ...
        if web == '今日头条':
            ...
            video_list_url = '//*[@class="cs-view cs-view-block cs-grid-cell grid-cell-3 grid-cell-x-m grid-cell-y-m"//@href'
        ...
        for video in video_list:
            ...
            if web == '哔哩哔哩':
                ...
                bid = print(video_page_url.split('/')[-2])
                print(bid)
                bids.append(bid)
...
c = jinritoutiao()
urls = c.fun_url(web='今日头条', keys='乌克兰')
